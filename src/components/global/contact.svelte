<form action="#" method="POST" class="mx-auto w-full">
  <div class="grid grid-cols-1 gap-x-2 gap-y-4 sm:grid-cols-2">
    ...
    <div class="sm:col-span-2">
      ...
      <div class="relative mt-2.5">
        ...
        <input
          ...
          id="phone-number"
          autocomplete="tel"
          class="block w-full rounded-md border-0 px-3.5 py-2 pl-20 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
        />
      </div>
    </div>
    <div class="sm:col-span-2">
    ...
    <div class="flex gap-x-4 sm:col-span-2">
      ...
      <label for="" class="text-sm leading-6" id="switch-1-label">
        By selecting this, you agree to our
        <a href="/" class="font-semibol">privacy&nbsp;policy</a>.
      </label>
    </div>
  </div>
  <div class="mt-10">
